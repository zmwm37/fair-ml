...
:::
::: {.column}
![Source: [Wikipedia "Confusion Matrix" Page ](https://en.wikipedia.org/wiki/Confusion_matrix)](confusion-matrix.JPG)
:::
::::::::::::::
...
:::
::: {.column}
![Source: [Wikipedia user MartinThoma](https://en.wikipedia.org/wiki/File:Roc-draft-xkcd-style.svg)](./roc-xkcd.jpg)
:::
::::::::::::::
...
for(i in g) {
  ...
  # plot
  plot(rocPerf, add = b, lwd = 3, lty = l, cex = 1.5, col = lineColors[z])
  text(x = 0.6, y = 0.5-(z*.1), labels = paste(g[z],' AUC: ', round(performance(pred, 'auc')@y.values[[1]],3)))
...
:::
::: {.column}
![Estimated Risk Distributions. Source: [Corbett-Davies et. al. 2018](https://arxiv.org/pdf/1808.00023.pdf)](violent-recid-dist.JPG)
